"""
GitFlow — AI Git assistant for commit messages, branching, and conflicts
...
class Router:
    """Cost- and latency-aware model router for GitFlow."""
...
if __name__ == "__main__":
    import argparse
    p = argparse.ArgumentParser(description="GitFlow: AI Git assistant for commit messages, branching, and conflicts")
